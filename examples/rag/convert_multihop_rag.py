...
random.seed(42)
path="data/MultiHopRAG"
corpus_input_file=os.path.join(path, "corpus.json")
corpus_output_file=os.path.join(path, "corpus.jsonl")
qa_input_file=os.path.join(path, "MultiHopRAG.json")
train_file=os.path.join(path, "train.jsonl")
val_file=os.path.join(path, "val.jsonl")
