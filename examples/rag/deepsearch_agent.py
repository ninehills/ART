...
AGENT_PROMPTS = {
    "default": """You answer questions using retrieval_server with only retrieved passages.

Workflow:
1. Reasoning before each search, use <think>...</think> format.
2. After search:
...
3. Max 5 search iterations.
4. If no answer found, reply <answer>Insufficient Information</answer>
"""
}
...
def main():
    ...
    run_parser.add_argument('--prompt-name', choices=list(AGENT_PROMPTS.keys()), default='default', help='Prompt name')
